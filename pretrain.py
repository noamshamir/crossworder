...
def init_train_state(config: PretrainConfig, train_metadata: PuzzleDatasetMetadata, rank: int, world_size: int):
    # Steps per epoch = groups / batch_size (the iterator samples one example
    # per group per epoch, regardless of how many augmented variants exist).
    steps_per_epoch = train_metadata.total_groups // config.global_batch_size
